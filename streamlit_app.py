...
x3=st.number_input('Enter the value of baseline value of expert',100,160)
x4=st.number_input('Enter the value of baseline of sisporto',100,160)
x5=st.number_input('Enter the value of acceleration of sisporto',1,26)
x6=st.number_input('Enter the value of foetal movement',1,600)
x7=st.number_input('Enter the value of uterine contraction',1,25)
x8=st.number_input('Enter the value of percentage of time with abnormal short term variability',1,100)
x9=st.number_input('Enter the value of mean value of short term variability',1,10)
x10=st.number_input('Enter the value of percentage of time with abnormal long term variability',1,100)
x11=st.number_input('Enter the value of  mean value of long term variability',1,60)
x12=st.number_input('Enter the value of  light deceleration',1,20)
...
x15=st.number_input('Enter the value of  width',1,200)
